...
const add_id = "sjoskdkakhiqujgt"; // app_id
const app_secret = "6gZeWfne5TDm2iAgqzNxvpOuL7vtY5Y2"; // app_secret
const mainKey = "8fd1655319f7d54a7982620b62dc6f03" // key
function getWeather() {
	fetch(`https://restapi.amap.com/v3/ip?key=${mainKey}`)
	    ...
	    .then((res) => {
	      ...
	      fetch(
	        `https://restapi.amap.com/v3/weather/weatherInfo?key=${mainKey}&city=130500`
	      )
	        .then((response) => response.json())
	        .then((res) => {
	          if (res.status) {
